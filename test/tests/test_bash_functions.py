...
CMD_SETUP_FTL_CACHESIZE='. /bash_functions.sh ; eval `grep setup_FTL_CacheSize /start.sh`'
CMD_SETUP_FTL_INTERFACE='. /bash_functions.sh ; eval `grep setup_FTL_Interface /start.sh`'
CMD_SETUP_WEB_PASSWORD='. /bash_functions.sh ; eval `grep setup_web_password /start.sh`'
